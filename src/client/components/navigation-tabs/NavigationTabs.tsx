...
const NavigationTabs = () => {
	...
	return (
		<div className="w-full flex flex-col md:flex-row items-center justify-between gap-4 transition-all duration-300">
			<nav className="w-full bg-white-0/95 dark:bg-gray-800/95 rounded-xl shadow-md backdrop-blur-sm overflow-hidden border border-gray-100 dark:border-gray-700">
				<ul className="flex items-center p-1">
                    ...
                    py-3 px-3 md:px-4 rounded-lg text-sm font-medium 
        ...
        `}
			...
			>
				<Icon
					icon={
						isDarkMode ? 'heroicons:sun-20-solid' : 'heroicons:moon-20-solid'
					}
					className="h-5 w-5"
				/>
			</button>
