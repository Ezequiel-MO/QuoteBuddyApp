	...
	return (
		<div className="min-h-screen w-full px-4 py-12 bg-[#e5ebf2]">
			<h1 className="text-3xl font-semibold text-center text-gray-900 mb-12">
				Group Name:{' '}
				<span className="text-[#e95420]">{currentProject.groupName}</span>
			</h1>
			...
			<div className="flex flex-wrap justify-center gap-10">
				...
				>
					...
					<p className="text-sm text-white/90 leading-relaxed">
						Access the complete trip details, including schedule, images,
						hotels, and more.
					</p>
				</div>
				...
				<div
					className="bg-[#4b5a70] text-white-0 rounded-xl p-6 w-80 cursor-pointer hover:scale-105  transition-all duration-300 ease-in-out active:scale-95 shadow-md hover:bg-amber-600"
					onClick={() => handleNavigate('/client/planner')}
				>
					<div className="flex items-center mb-4">
						<Icon
							icon="mdi:calendar-check"
							className="mr-2 text-white-0"
							width="24"
							height="24"
						/>
						<h2 className="text-lg">Start Planning the Event</h2>
					</div>
					<p className="text-sm text-white/90 leading-relaxed">
						Work directly with your account manager to plan your event, review
						options, and collaborate on the final itinerary.
					</p>
				</div>
			</div>
		</div>
