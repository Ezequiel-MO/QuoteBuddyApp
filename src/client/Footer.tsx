		...
		>
			...
			<div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg border-l-4 border-orange-500 dark:border-orange-400 shadow-sm">
				<div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
					...
					<a
						href="mailto:oliverm316@gmail.com?subject=QUOTE/Buddy%20Inquiry&body=I'm%20interested%20in%20using%20QUOTE/Buddy%20for%20my%20business."
					...
					<div>
						...
						<div className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
							<p className="italic">
								...
								<span className="font-semibold">
									Say goodbye to the old ways and hello to automated RFP
									responses.
								</span>
								<span className="font-light">
									{' '}
