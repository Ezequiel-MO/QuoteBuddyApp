...
export const ThumbnailPDF: React.FC<ThumbnailProps> = ({
    imageSrc,
    onImageUpload,
    isLoading = false,
    onDelete
                    ...
                    <div className="relative w-full h-full">
                        {
                            (
                                <div
                                    className="flex flex-col items-center justify-center w-full h-full bg-gray-200 rounded-lg"
                                    onClick={(e) => {
                                        e.stopPropagation()
