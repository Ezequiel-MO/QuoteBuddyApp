...
const DashboardSidebar = () => {
  ...
  useEffect(()=>{
    if(location.pathname == '/app/dashboard' || location.pathname == '/app/hotel' || location.pathname == '/app/project'){
      
      setDashboardDataList(dashboardData.slice(0, 5).concat(dashboardData.slice(7, 9)))
