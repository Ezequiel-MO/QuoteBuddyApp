        ...
        <div className='flex flex-col w-full'>
          ...
          <div className='flex flex-row justify-start items-center'>
            ...
            <button
              ...
              className='mx-5 focus:scale-110 hover:animate-pulse bg-transparent hover:bg-orange-50 text-white-100 uppercase font-semibold hover:text-black-50 py-2 px-4 h-20 border border-orange-50 hover:border-transparent rounded'
            >
              Create New Hotel
            </button>
