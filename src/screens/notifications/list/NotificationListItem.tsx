...
import { ButtonDeleted } from "src/components/atoms"
import { INotafication } from "@interfaces/notification"

interface NotificationListItemProps {
    notification: INotafication
    notifications: INotafication[]
    setNotification: (notifications: INotafication[]) => void
}


export const NotificationListItem: FC<NotificationListItemProps> = ({ notification, notifications, setNotification }) => {
    const navigate = useNavigate()

    const handleNavigate = () => {
        navigate('/app/notification/specs', { state: { notification: notification } })
    }
