...
export const ClientListRestoreItem: FC<ClientListRestoreItemProps> = ({ item: client }) => {
	...
	return (
		<tr className={listStyles.tr}>
			<td className={`${listStyles.td} hover:text-blue-600 hover:underline flex items-center`}>
            ...
            <td>
                <ClientDetailModal client={client} open={openModal} setOpen={setOpenModal} />
                <MenuRestoreActions 
                    item={client} 
                    itemType='Client'
