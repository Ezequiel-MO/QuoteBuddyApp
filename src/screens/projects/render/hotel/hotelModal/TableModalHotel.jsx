...
export const TableModalHotel = ({
	...
	useEffect(() => {
		setData({
			...
			DUInr: hotel?.price[0]?.DUInr || 0,
			DUIprice: hotel?.price[0]?.DUIprice || 0,
			DoubleRoomNr: hotel?.price[0]?.DoubleRoomNr || 0,
			DoubleRoomPrice: hotel?.price[0]?.DoubleRoomPrice || 0,
			breakfast: hotel?.price[0]?.breakfast || 0,
			DailyTax: hotel?.price[0]?.DailyTax || 0
		})
		setIsChecked({
			...isChecked,
			DUInr: false,
