...
export const ItineraryTransferRender: FC<ItineraryTransferRenderProps> = ({ itinerary, dayIndex, setDayIndex , date }) => {
    ...
    return (
        <div>
            <IntroAdd events={itinerary} setOpen={setOpenModalntro} />
            <IntroModal
                open={openModalIntro}
