...
export const ProjectListRestoreItem: FC<ProjectListRestoreItemProps> = ({
	item: project
}) => {
	...
	return (
		<tr className={`${listStyles.tr}`}>
			...
			<td className={`${listStyles.td} truncate`}>{project.groupLocation}</td>
			<td className={`${listStyles.td} truncate`}>
				{project?.clientCompany[0]?.name || project?.clientCompanyName}
			</td>
			<td className={`${listStyles.td} truncate`}>{project.groupName}</td>
			<td className={`${listStyles.td} truncate`}>{project.nrPax}</td>
			<td className={`${listStyles.td}`}>{project.arrivalDay}</td>
			<td className={`${listStyles.td}`}>{project.departureDay}</td>
			<td className={`${listStyles.td} truncate`}>{project.status}</td>
			<td className={`${listStyles.td} truncate`}>
