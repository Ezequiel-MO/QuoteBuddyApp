...
export const ProjectMasterForm: FC<ProjectMasterFormProps> = ({ submitForm, project, update , preValues }) => {
    ...
    const handleSubmitFormPdf = (values: any, files: File[], url: string, update: boolean) => {
