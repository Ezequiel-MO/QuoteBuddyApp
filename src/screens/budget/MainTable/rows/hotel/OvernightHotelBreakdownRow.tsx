...
type FieldName = "DUIprice" | "DoubleRoomNr" | "DoubleRoomPrice" | "breakfast" | "DailyTax"
...
export const OvernightHotelBreakdownRow: React.FC<OvernightHotelBreakdownRowProps> = ({
    units,
    rate,
    nights,
    title,
    ...
    const types = [
        ...
        { name: "Double Room //Twin Room", unit: "DoubleRoomNr", price: "DoubleRoomPrice" },
        { name: "City Tax", unit: "", price: "DailyTax" },
        { name: "Breakfast", unit: "", price: "breakfast" }
    ]

    const handleUpdate = async (newValue: number, title: string, typeValue: 'unit' | 'price') => {
        try {
            ...
            dispatch({
                type: "UPDATE_OVERNIGHT_HOTEL_PRICE",
                payload: {
                    dayIndex,
